//Uma const não pode ser criada sem inicializador (valor)
const numero = 0;
// const minhaVar = 'Oi';
...
//Stacktrace ==>> todos os caminhos e bibliotecas utilizadas para executar nosso arquivo
...
consegue executá-lo. Os erros podem ser métodos ou propriedades escritos ou utilizados de forma
incorreta, por exemplo, operadores ou sinais gráficos com elementos a menos, como esquecer de fechar
chaves ou colchetes.
